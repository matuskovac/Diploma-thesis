...
MODELS_DICT1 = {
    ...
    'svm': {'name': 'svm', 'params': {'kernel': 'linear'}, 'x_columns': '100_RandomForestClassifierWithCoef(min_samples_leaf=5, n_estimators=500, n_jobs=-1)'},
...
MODELS_DICT2 = {
    ...
    'svm': {'name': 'svm', 'params': {'kernel': 'sigmoid'}, 'x_columns': '10_RandomForestClassifierWithCoef(min_samples_leaf=5, n_estimators=500, n_jobs=-1)'},
